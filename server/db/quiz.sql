...
('Monia', 'monia@hackboys.com', '$2b$10$.pj1LTt4HxpVVg6fZDhdFOMBfiywBTikuDqx3KjDy85aJNyZ4IoJC','2023-07-26 16:23:24 +0000', 1),
('Simon', 'simon@hackboys.com', '$2b$10$.pj1LTt4HxpVVg6fZDhdFOMBfiywBTikuDqx3KjDy85aJNyZ4IoJC','2023-07-26 16:23:24 +0000', 0),
('Sarah', 'sarah@hackboys.com', '$2b$10$.pj1LTt4HxpVVg6fZDhdFOMBfiywBTikuDqx3KjDy85aJNyZ4IoJC','2023-07-26 16:23:24 +0000', 1);
...
VALUES (1, 'Hack', 0, 0), (2, 'Street', 0, 0), (3, 'Monia', 0, 0), (4, 'Simon', 0, 0),(5, 'Sarah', 0, 0) ;

INSERT INTO Quizzes (quiz_id, user_id, beginner_score, intermediate_score, advanced_score, language_id)
VALUES (1, 1, 10, 20, 30, 1), (2, 1, 0, 7, 6, 2), (1, 2, 5, 10, 20, 1), (1, 1, 5, 10, 20, 2), (1, 2, 15, 5, 15, 2),(2, 1, 10, 10, 10, 1),
(1,3,10,20,30,1),(1,3,10,20,30,2),(2,3,10,20,30,1), (2,3,10,20,30,2),(1,4,10,0,0,1),(1,4,10,0,0,2),(1,5,10,20,30,1),(1,5,10,20,30,2),(2,5,10,20,30,1),(2,5,10,20,30,2);

UPDATE Leaderboards SET score_spanish = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 1) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 1) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 1)) WHERE user_id = 1;

UPDATE Leaderboards SET score_spanish = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 2) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 2) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 2)) WHERE user_id = 2;

UPDATE Leaderboards SET score_spanish = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 3) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 3) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 3)) WHERE user_id = 3;

UPDATE Leaderboards SET score_spanish = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 4) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 4) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 4)) WHERE user_id = 4;

UPDATE Leaderboards SET score_spanish = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 5) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 5) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 1 AND  user_id = 5)) WHERE user_id = 5;

UPDATE Leaderboards SET score_italian = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 1) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 1) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 1)) WHERE user_id = 1;

UPDATE Leaderboards SET score_italian = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 2) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 2) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 2)) WHERE user_id = 2;

UPDATE Leaderboards SET score_italian = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 3) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 3) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 3)) WHERE user_id = 3;

UPDATE Leaderboards SET score_italian = (SELECT (SELECT COALESCE(SUM(beginner_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 4) + (SELECT COALESCE(SUM(intermediate_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 4) + (SELECT COALESCE(SUM(advanced_score), 0) FROM Quizzes WHERE language_id = 2 AND  user_id = 4)) WHERE user_id = 4;
...
UPDATE Leaderboards SET rank = CASE WHEN CAST(score_italian as INT) + CAST(score_spanish as INT) > 160 THEN 5 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 120 THEN 4 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 80 THEN 3 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 40 THEN 2 ELSE 1 END WHERE user_id = 3;

UPDATE Leaderboards SET rank = CASE WHEN CAST(score_italian as INT) + CAST(score_spanish as INT) > 160 THEN 5 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 120 THEN 4 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 80 THEN 3 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 40 THEN 2 ELSE 1 END WHERE user_id = 4;

UPDATE Leaderboards SET rank = CASE WHEN CAST(score_italian as INT) + CAST(score_spanish as INT) > 160 THEN 5 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 120 THEN 4 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 80 THEN 3 WHEN CAST(score_italian as INT) + CAST(score_spanish as INT)  > 40 THEN 2 ELSE 1 END WHERE user_id = 5;
-- Easy way of visualising each user
-- SELECT * FROM Quizzes ORDER BY user_id, quiz_id, language_id
